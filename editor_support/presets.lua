...
function P.make(index)
  ...
  if index==7 then
    ...
    l.emitter.sizes={12};l.emitter.blendMode='alpha';l.emitter.colors={color(palette.blue,0.8),color(palette.teal,0.75),color(palette.peach,0)}
  ...
  elseif index==5 then
    ...
    l.emitter.colors={color(palette.beige,1),color(palette.peach,1),color(palette.blue,0)}
  ...
  elseif index==6 then
    ...
    l.emitter.colors={color(palette.teal,0),color(palette.blue,0.84),color(palette.peach,0)}
    ...
    l.appearance.outlineColor={palette.teal[1],palette.teal[2],palette.teal[3]}
  elseif index==2 then
    ...
    l.emitter.colors={color(palette.teal,0),color(palette.blue,0.75),color(palette.peach,0)};l.curl.enabled=true;l.curl.amplitude=9
    local core=D.copy(l);core.name='Soft halo';core.emitter.max=1200;core.emitter.rate=280;core.emitter.sizes={8,34,0};core.emitter.colors={color(palette.blue,0),color(palette.teal,0.10),color(palette.beige,0)}
  ...
  elseif index==3 then
    ...
    l.emitter.lifetime={2.4,3};l.emitter.sizes={2,3,0};l.emitter.colors={color(palette.blue,0.65),color(palette.teal,0.7),color(palette.beige,0)}
    ...
    mist.emitter.speed={4,20};mist.emitter.gravity={0,-8};mist.emitter.sizes={8,32,65};mist.emitter.colors={color(palette.blue,0),color(palette.teal,0.04),color(palette.beige,0)}
    d.layers={l,mist}
  elseif index==4 then
    ...
    l.emitter.sizes={4,2,0};l.emitter.lifetime={0.6,1.6};l.emitter.colors={color(palette.beige,1),color(palette.peach,0.85),color(palette.blue,0)}
    ...
    flash.emitter.sizes={6,70,0};flash.emitter.lifetime={0.15,0.3};flash.emitter.colors={color(palette.beige,0.65),color(palette.peach,0.18),color(palette.blue,0)}
    ...
    smoke.emitter.lifetime={1.3,2.4};smoke.emitter.sizes={10,38,60};smoke.emitter.colors={color(palette.peach,0),color(palette.peach,0.08),color(palette.blue,0)}
    ...
    sparks.emitter.colors={color(palette.beige,0.9),color(palette.peach,0.7),color(palette.blue,0)}
    ...
    smoke.emitter.colors={color(palette.peach,0),color(palette.teal,0.10),color(palette.blue,0)}
