...
function M.run()
  ...
  assert(fluid.push[1]==674 and fluid.push[2]==306 and fluid.push[3]==55 and fluid.push[4]>0 and fluid.circle[4]==0)
  scene:toggleMouse();scene:stepOnce();assert(fluid.push[4]==0,'push toggle must reach water solver')
